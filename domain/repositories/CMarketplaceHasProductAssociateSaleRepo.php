...
/**
 * Class CMarketplaceHasProductAssociateSaleRepo
 ...
 * @since 1.0
 */
class CMarketplaceHasProductAssociateSaleRepo extends ARepo
{

    public function UpdateProductToMarketPlacePrestaShop(CProduct $product,$shopId, $marketPlaceId,$prestashopId,$typeRetouchPrice,$amount,$marketplaceHasShopId)
    {
...
$price=0;
       ...
       $marketplaceHasProductAssociate2 = \Monkey::app()->repoFactory->create('MarketplaceHasProductAssociate')->findOneBy(['productId'=>$product->id,'productVariantId'=>$product->productVariantId,'shopId'=>$shopId,'prestashopId'=>$prestashopId,'marketplaceId'=>$marketPlaceId,'marketPlaceHasShopId'=>$marketplaceHasShopId]);
        if ($marketplaceHasProductAssociate2 == null) {
            ...
            $marketplaceHasProductAssociate->price = $price;
            ...
            $marketplaceHasProductAssociate2->statusPublished = 0;
            ...
            $marketplaceHasProductAssociate2->price = $price;
