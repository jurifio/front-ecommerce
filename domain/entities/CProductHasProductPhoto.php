 ...
 *
 */
class CProductHasProductPhoto extends AEntity
{
    protected $entityTable = 'ProductHasProductPhoto';
    protected $primaryKeys = ['productId', 'productVariantId','ProductPhotoId'];
