 ...
 * @package bamboo\app\con    trollers
 */
class CCartController extends ARootController
{
    /**
    ...
    {
        $view = new CRootView($request,$this->app->rootPath().$this->app->cfg()->fetch('paths','store-theme').'/pages/cart.php');
