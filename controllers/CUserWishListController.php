 ...
 * @since 1.0
 */
class CUserWishListController extends ARootController
{
    /**
    ...
    {
        $view = new CRootView($request,$this->app->rootPath().$this->app->cfg()->fetch('paths','store-theme').'/pages/userwishlist.php');
