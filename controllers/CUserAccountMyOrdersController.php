 ...
 * @since 1.0
 */
class CUserAccountMyOrdersController extends AUserAccountRootController
{
    /**
    ...
    {
        $view = new CRootView($request,$this->app->rootPath().$this->app->cfg()->fetch('paths','store-theme').'/pages/useraccountorders.php');
