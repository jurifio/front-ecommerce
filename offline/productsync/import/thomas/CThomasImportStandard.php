    ...
    public function processFile($file)
    {
        ...
        while (($values = fgetcsv($f, 0, ";")) !== false) {
            ...
            try {
                ...
                $findDirtyProductId=\Monkey::app()->repoFactory->create('DirtyProduct')->findOneBy(['itemno'=>$assoc['itemno'],'shopId'=>58]);
                ...
                if(isset($skusChecksums[$dirtySku['checksum']])) {
                    ...
                    if(count($existingSku) == 0) {
                        ...
                        if(!$findDirtyHasStoreHouse){
                            ...
                            $findProductId=\Monkey::app()->repoFactory->create('DirtyProduct')->findOneBy(['id'=>$dirtyProduct['id']]);
                        ...
                        if(!$findDirtyHasStoreHouse){
                            ...
                            $findProductId=\Monkey::app()->repoFactory->create('DirtyProduct')->findOneBy(['id'=>$existingSku[0]['dirtyProductId']]);
