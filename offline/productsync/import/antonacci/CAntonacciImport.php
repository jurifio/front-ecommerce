<?php
namespace bamboo\offline\productsync\import\antonacci;
...
class CAntonacciImport extends AGf888Import {
	...
	public function getShop()
	{
		...
		$obc = $em->findBySql("SELECT id FROM Shop WHERE `name` = ?", array('antonacci'));
		return $obc->getFirst();
	}
	...
	public static function getDummyPic($dirtyProductId, AApplication $app)
	{
		...
		$config = new CConfig(__DIR__."/import.antonacci.config.json");
		$config->load();
